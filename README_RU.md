...
- ✅ Сбор системной информации: ОС, ядро, время работы и информация о железе
- ✅ Мониторинг использования CPU, памяти и диска для анализа производительности
- ✅ Список активных сетевых интерфейсов и всех слушающих портов
- ✅ Аудит конфигураций брандмауэра: **iptables**, **nftables**, **UFW**, **firewalld**
- ✅ Проверка статуса **Fail2Ban** и заблокированных IP
- ✅ Анализ конфигурации SSH и логов на предмет подозрительной активности
- ✅ Генерация **отчётов с отметкой времени** в формате удобочитаемого текста и JSON для автоматизированного анализа
- ✅ Маскировка конфиденциальных данных (ключи, пароли) в конфигурационных файлах для безопасного обмена
